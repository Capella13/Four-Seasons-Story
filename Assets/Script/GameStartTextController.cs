...
//using UnityEditor.PackageManager.UI; [이것때문에 빌드 안 됨. 삭제해야함.]
using UnityEngine;
using UnityEngine.EventSystems;
using UnityEngine.UI;

public class GameStartTextController : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler //IPointerEnterHandler와 IPointerExitHandler | 인터페이스 | 마우스 포인터가 UI에 들어오거나 나갈 때의 이벤트 처리.
{
